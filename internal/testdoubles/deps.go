...
// GetByUsername delegates to GetByUsernameFn or returns (nil, nil) by default.
...
// GetByID delegates to GetByIDFn or returns (nil, nil) by default.
...
// Create delegates to CreateFn or returns a User with the supplied username by default.
...
// Count delegates to CountFn or returns (0, nil) by default.
...
// Create delegates to CreateFn or returns nil by default.
...
// GetByToken delegates to GetByTokenFn or returns (nil, nil) by default.
...
// Delete delegates to DeleteFn or returns nil by default.
...
// DeleteExpired delegates to DeleteExpiredFn or returns nil by default.
...
// AddWaterEvent delegates to AddWaterEventFn or returns (0, nil) by default.
...
// DeleteWaterEvent delegates to DeleteWaterEventFn or returns nil by default.
...
// ListRecentWaterEvents delegates to ListRecentWaterEventsFn or returns (nil, nil) by default.
...
// WaterTotalForLocalDay delegates to WaterTotalForLocalDayFn or returns (0, nil) by default.
...
// AddWeightEvent delegates to AddWeightEventFn or returns (0, nil) by default.
...
// DeleteLatestWeightEvent delegates to DeleteLatestWeightEventFn or returns (false, nil) by default.
...
// LatestWeightForLocalDay delegates to LatestWeightForLocalDayFn or returns (nil, nil) by default.
...
// ListRecentWeightEvents delegates to ListRecentWeightEventsFn or returns (nil, nil) by default.
